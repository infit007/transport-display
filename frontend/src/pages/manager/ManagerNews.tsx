  ...
  return (
    <ManagerLayout>
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Assign Existing Media to Multiple Buses</CardTitle>
            <p className="text-sm text-muted-foreground">Note: Managers can only assign existing media, not upload new files</p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <Label>2) Select Existing Media</Label>
                <div className="flex items-center gap-3">
                  <Button type="button" variant="outline" onClick={() => fetch(`${backendUrl}/api/media/public`).then(r => r.json()).then((l) => setMediaItems(Array.isArray(l) ? l : []) )}>Refresh Media List</Button>
                </div>
                <div className="mt-3 max-h-56 overflow-auto border rounded-md">
